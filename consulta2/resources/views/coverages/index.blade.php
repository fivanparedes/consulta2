@extends('layouts.app', ['activePage' => 'coverages', 'title' => $companyName.' | Lista de Obras Sociales',
                                ...
                                <div class="row ml-4">
                                    ...
                                    <div class="col" style="width: 10%;">
                                        <div class="">
                                            ...
                                            <a class="nav-link" href="/coverages_pdf?filter1={{ $filter1 }}&filter2={{ $filter2 }}&filter3={{ $filter3 }}&filter4={{ $filter4 }}" title="Generar PDF">
