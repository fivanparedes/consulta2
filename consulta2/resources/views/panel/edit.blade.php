@extends('layouts.app', ['activePage' => 'role_permissions', 'title' => $companyName.' | Editar permiso', 'navName' => 'Configuración', 'activeButton' => 'laravel'])
  ...
  <div class="content flex flex-col">
    <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-32">
      ...
      >
        ...
        @endif
        <label class="block">
          <span class="text-gray-700">Nombre/Código</span>
          <input
        ...
        <label class="block my-4">
          <span class="text-gray-700">Nombre visual</span>
          <input
        ...
        @if($type == 'role')
          <span class="block text-gray-700">Permisos</span>
