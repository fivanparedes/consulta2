@extends('layouts.app', ['activePage' => 'role_permissions', 'title' => $companyName.' | Asignación de roles', 'navName' => 'Configuración', 'activeButton' => 'laravel'])
      ...
      >
        ...
        <label class="block">
          ...
          <input
            ...
            value="{{$user->name .' '.$user->lastname ?? 'The model doesn\'t have a `name` attribute'}}"
            readonly
            autocomplete="off"
          >
        </label>
        ...
        @if ($permissions)
          <span class="block text-gray-700 mt-4">Permisos</span>
          <div class="flex flex-wrap justify-start mb-4">
